...
interface CatalagoProps {
  nome: string;
}

const Catalago = ({ nome }: CatalagoProps) => {
...
export async function getServerSideProps(context: GetServerSidePropsContext): Promise<GetServerSidePropsResult<CatalagoProps>> {
